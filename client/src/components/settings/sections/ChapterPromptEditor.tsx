...
const PLACEHOLDER_HELP = {
    detection: [
        ...
        { placeholder: "{{previousChapter}}", description: "Previous batch chapter context (optional)" },
    ],
    metadata: [
...
const getEmptyForm = (operation: ChapterPromptFormData["operation"]): ChapterPromptFormData => ({
    ...
    userPromptTemplate: operation === "detection" ? DEFAULT_CHAPTER_DETECTION_USER_PROMPT_TEMPLATE : "",
    instructions: "",
});
...
export function ChapterPromptEditor({
    ...
    const initialOperation = (initialData?.operation as ChapterPromptFormData["operation"]) || "detection";
    ...
    const [form, setForm] = useState<ChapterPromptFormData>({
        ...
        systemPrompt: initialData?.systemPrompt || (initialOperation === "detection" ? DEFAULT_CHAPTER_DETECTION_SYSTEM_PROMPT : ""),
        userPromptTemplate: initialData?.userPromptTemplate || (initialOperation === "detection" ? DEFAULT_CHAPTER_DETECTION_USER_PROMPT_TEMPLATE : ""),
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(val) => handleOperationChange(val as ChapterPromptFormData["operation"])}
            ...
            {form.operation === "rewrite" ? (
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Describe how the AI should rewrite the chapter text. The input will be the full chapter text.
                    </p>
                </div>
            ) : (
                <>
