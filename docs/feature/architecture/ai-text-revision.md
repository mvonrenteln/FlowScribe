...
- File sync warning: Always save in-memory changes before running terminal commands (builds/tests). Running commands against unsaved files leads to stale-state confusion during development and CI runs.
